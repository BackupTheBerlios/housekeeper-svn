 ...
 */
public final class ShoppingListManager extends AbstractManager
{

    /**
     * Log to be used for this class.
     */
    private static final Log LOG = LogFactory.getLog(ShoppingListManager.class);
     ...
     */
    public void add(final ShoppingListItem item)
    {
        items.add(item);
        setChanged();
     ...
     */
    public void remove(final ShoppingListItem item)
    {
        items.remove(item);
        setChanged();
    ...
    public boolean equals(Object o)
    {
        ...
        ShoppingListManager castedObj = (ShoppingListManager) o;
